...
const OrderConfirmation: React.FC<OrderConfirmationProps> = ({}) => {
    const {orderSummary, payment, shipping} = useOrderContext();
    useEffect(() => {
    ...
    return (
        <section className={style['order-confirmation']}>
            ...
            {orderSummary && <FieldsDisplayer items={[orderSummary]} imageUrl={orderSummary.imageUrls[0]} sectionTitle="Order Details" />}
